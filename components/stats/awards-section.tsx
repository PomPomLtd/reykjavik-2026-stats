      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <AwardCard gameId={awards.bloodbath.gameId} className="bg-red-50 dark:bg-red-900/20">
          ...
          <div className="text-sm text-gray-700 dark:text-gray-300">
            <PlayerVs white={awards.bloodbath.white} black={awards.bloodbath.black} round={awards.bloodbath.round} />
          </div>
        ...
        <AwardCard gameId={awards.pacifist.gameId} className="bg-green-50 dark:bg-green-900/20">
          ...
          <div className="text-sm text-gray-700 dark:text-gray-300">
            <PlayerVs white={awards.pacifist.white} black={awards.pacifist.black} round={awards.pacifist.round} />
          </div>
        ...
        {awards.speedDemon && (
          <AwardCard gameId={awards.speedDemon.gameId} className="bg-yellow-50 dark:bg-yellow-900/20">
            ...
            <div className="text-sm text-gray-700 dark:text-gray-300">
              <PlayerVs white={awards.speedDemon.white} black={awards.speedDemon.black} round={awards.speedDemon.round} />
            </div>
        ...
        <AwardCard gameId={awards.endgameWizard.gameId} className="bg-purple-50 dark:bg-purple-900/20">
          ...
          <div className="text-sm text-gray-700 dark:text-gray-300">
            <PlayerVs white={awards.endgameWizard.white} black={awards.endgameWizard.black} round={awards.endgameWizard.round} />
          </div>
