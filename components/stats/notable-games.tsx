      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <AwardCard gameId={overview.longestGame.gameId} className="bg-purple-50 dark:bg-purple-900/20">
          ...
          <div className="text-sm text-gray-700 dark:text-gray-300">
            <PlayerVs white={overview.longestGame.white} black={overview.longestGame.black} round={overview.longestGame.round} />
          </div>
        ...
        <AwardCard gameId={overview.shortestGame.gameId} className="bg-blue-50 dark:bg-blue-900/20">
          ...
          <div className="text-sm text-gray-700 dark:text-gray-300">
            <PlayerVs white={overview.shortestGame.white} black={overview.shortestGame.black} round={overview.shortestGame.round} />
          </div>
          <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">
        ...
        <AwardCard gameId={longestNonCaptureStreak.gameId} className="bg-green-50 dark:bg-green-900/20">
          ...
          <div className="text-sm text-gray-700 dark:text-gray-300">
            <PlayerVs white={longestNonCaptureStreak.white} black={longestNonCaptureStreak.black} round={longestNonCaptureStreak.round} />
          </div>
          <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">
